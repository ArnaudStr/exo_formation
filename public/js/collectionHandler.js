    ...
    var $addTagButton = $('<button type="button" class="add_link">Ajout</button>');
    var $delTagButton = $('<button type="button" class="del_link">Supprimer</button>');
